    ...
    <div className="border-b border-neutral-900 pb-4">
      ...
      <div>{EXPERIENCES.map((experiences,index)=>(
          <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
            ...
            <motion.div whileInView={{opacity:1,x:0}} initial={{x:100,opacity:0}} transition={{duration:2}} className="w-full max-w-xl lg:w-3/4">
              <h6 className="pb-2 font-semibold">{experiences.role}
